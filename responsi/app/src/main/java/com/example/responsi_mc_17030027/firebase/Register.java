package com.example.responsi_mc_17030027.firebase;
...
import com.example.responsi_mc_17030027.recyclerview_connect_api.activity.MainActivity;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), com.example.responsi_mc_17030027.firebase.Login.class));
            }
        });
